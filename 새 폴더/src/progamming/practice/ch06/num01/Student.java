...
public class Student extends Person{
	...
	public Student(String name, int age, String address, String schoolName, String dept, String studentId) {
	...
	public static void main(String[] args) {
		...
		System.out.println("8학기 학점을 순서대로 입력하시오.");
		...
		System.out.println(s1.avgScore.length + "학기 총 평균 평점은 " + s1.average() + "점입니다.");
	}
